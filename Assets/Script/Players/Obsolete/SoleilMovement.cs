...
public class SoleilMovement : MonoBehaviour
{
    ...
    void GetInput()
    {
        input.x = Input.GetAxisRaw("SHorizontal");
        input.y = Input.GetAxisRaw("SVertical");
    ...
    void Animating()
    {
        bool walking = Input.GetAxisRaw("SHorizontal") != 0f || Input.GetAxisRaw("SVertical") != 0f;
